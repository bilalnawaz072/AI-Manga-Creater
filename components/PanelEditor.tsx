...
const ASPECT_RATIO_CONFIG: { [key: string]: { w: number, h: number } } = {
    'A4': { w: 595, h: 842 },
    'Portrait (3:4)': { w: 600, h: 800 },
    'Square (1:1)': { w: 800, h: 800 },
...
// FIX: The error indicates a `drawing` shape was created with `arrow` points.
// This kind of error is often a typo where the `type` property is incorrect.
